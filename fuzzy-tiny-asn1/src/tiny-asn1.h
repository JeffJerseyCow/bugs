...
/**
 * \brief Calculates the length part of the whole TLV block at the beginning of \p inf the whole TLV block at the beginning of \p in
 *
 * \param in The DER encoded data to parse
 * \param inlen Length of the data available at \p in
 *
 ...
 * \param out_objects Reference to a list of objects where decoded child can be stored to. The size of this list xan be calculated with ::der_object_count
